...
const colorType: Record<string, ColorType> = {
    fire: { card: "#ff986b", chip: "#fff2db" },
    grass: { card: '#5eff8b', chip: '#f2f2f2' },
    water: { card: "#95beff", chip: "#007acc" },
    normal: { card: "#c7d1d5", chip: "#f2f2f2" },
